module ApplicationHelper
  ...
  def find_time_from_calories_gender_height_weight_age(calories, gender, height, weight, age)
    weight_in_kg = Calculate.lb_to_kg(weight)
    height_in_cm = Calculate.in_to_cm(height)
    bmr          = Calculate.bmr_from_gender_height_weight_age(gender, height_in_cm, weight_in_kg, age)
